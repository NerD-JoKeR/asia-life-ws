...
import ffinlife.ws.CalculatorFreedomKidsRequest;
import ffinlife.ws.CalculatorFreedomKidsResponse;
...
@Component
public class CalculatorFreedomKidsComponent extends CommonComponent {

    public CalculatorFreedomKidsResponse freedomKids(CalculatorFreedomKidsRequest request){

        CalculatorFreedomKidsResponse commonResponse = checkSession(request, new CalculatorFreedomKidsResponse());
        if(commonResponse != null){
            return commonResponse;
        }

        CalculatorFreedomKidsResponse response = new CalculatorFreedomKidsResponse();
        ...
        try {
            ...
            response.setOutALL(callableStatement.getString(24));
